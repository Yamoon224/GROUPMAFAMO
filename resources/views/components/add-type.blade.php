<div class="modal fade fixed top-0 right-0 overflow-y-auto overflow-x-hidden dz-scroll w-full h-full z-[1055] translate-y-[-50px] dz-modal-box model-close" id="new-type">
                ...
                <form action="{{ route('types.store') }}" method="post">
                    ...
                    <div class="row">	
                        <div class="xl:w-full mb-4">
                            ...
                            <input type="text" name="type" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full" id="type" placeholder="@lang('locale.type', ['suffix'=>''])" required>
                        </div>	
