<x-app-layout>
    ...
    <div class="page-titles dark:bg-[#242424] flex items-center justify-between relative border-b border-[#E6E6E6] dark:border-[#444444] flex-wrap z-[1] py-[0.6rem] sm:px-[1.95rem] px-[1.55rem] bg-white">
        <ol class="text-[13px] flex items-center flex-wrap bg-transparent">
            ...
            <li class="pl-2 before:content-['/'] before:font-[simple-line-icons] before:font-black before:text-xl before:leading-4 before:pr-2 before:float-left before:text-primary text-primary font-medium"><a>@lang('locale.new', ['param'=>__('locale.contract', ['suffix'=>''])])</a></li>
        </ol>
    </div>
            ...
            <div class="w-full col-xxl-12">
                <div class="card">
                    <div class="card-header flex flex-wrap justify-between items-center sm:p-5 sm:pt-6 p-4 pt-5 max-sm:pb-5 relative border-b border-[#E6E6E6] dark:border-[#444444]">
                        <h4 class="card-title capitalize">@lang('locale.new', ['param'=>__('locale.contract', ['suffix'=>''])])</h4>
                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="lg:w-1/2 mb-2">
                                                    <div class="mb-4">
                                                        ...
                                                        <select class="single-select" name="contract[partner_id]" required>
                                                            ...
                                                            <option value="{{ $item->id }}">{{ $item->type.' : '.$item->company }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="lg:w-full mb-2">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" name="contract[title]" class="relative text-[13px] h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full" placeholder="@lang('locale.title')" required>
                                                    </div>
                                                </div>
                                                <div class="lg:w-1/2 mb-2">
                                                    <div class="mb-4">
                                                        <label class="text-body-color dark:text-white">@lang('locale.cost') <span class="required text-danger">*</span></label>
                                                        <input type="number" name="contract[cost]" class="relative text-[13px] h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full" placeholder="@lang('locale.cost')" required>
                                                    </div>
                                                </div>
                                                <div class="lg:w-1/2 mb-2">
                                                    <div class="mb-4">
                                                        <label class="text-body-color dark:text-white">@lang('locale.workforce') <span class="required text-danger">*</span></label>
                                                        <input type="number" name="contract[workforce]" class="relative text-[13px] h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full" placeholder="@lang('locale.workforce')" required>
                                                    </div>
                                                </div>
                                                <div class="lg:w-1/2 mb-2">
                                                    <div class="mb-4">
                                                        <label class="text-body-color dark:text-white">@lang('locale.began_at') <span class="required text-danger">*</span></label>
                                                        <input type="date" name="contract[began_at]" class="relative text-[13px] h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full" id="began_at" required>
                                                    </div>
                                                </div>
                                                <div class="lg:w-1/2 mb-2">
                                                    <div class="mb-4">
                                                        <label class="text-body-color dark:text-white">@lang('locale.ended_at') <span class="required text-danger">*</span></label>
                                                        <input type="date" name="contract[ended_at]" class="relative text-[13px] h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full" id="ended_at" required>
                                                    </div>
                                                </div>
                                                <div class="w-full mb-4">
                                                    <div class="mb-4">
                                                        <label class="text-body-color dark:text-white">@lang('locale.description')</label>
                                                        <textarea rows="3" style="resize: none" name="contract[description]" class="form-control relative text-[13px] h-auto min-h-auto border border-b-color block rounded-md p-3 duration-500 focus:border-primary dark:hover:border-b-color outline-none w-full resize-y"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <tbody id="tbody">
                                                            <tr>
                                                                <td class="py-[0.9375rem] px-2.5 capitalize whitespace-nowrap sm:text-sm text-xs font-normal border-t border-[#E6E6E6] dark:border-[#444444] text-left text-body-color">
                                                                    <input type='text' name="details[1][category]" placeholder="@lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'y' : ''])" class="form-control form-control-sm" required>
                                                                </td>
                                                                <td class="py-[0.9375rem] px-2.5 capitalize whitespace-nowrap sm:text-sm text-xs font-normal border-t border-[#E6E6E6] dark:border-[#444444] text-left text-body-color">
                                                                    <input type='text' name="details[1][label]" class="form-control form-control-sm" placeholder="@lang('locale.label')" required>
                                                                </td>
                                                                <td class="py-[0.9375rem] px-2.5 capitalize whitespace-nowrap sm:text-sm text-xs font-normal border-t border-[#E6E6E6] dark:border-[#444444] text-left text-body-color">
                                                                    <input type='text' name="details[1][unit]" class="form-control form-control-sm" placeholder="@lang('locale.unit')" required>
                                                                </td>
                                                                <td class="py-[0.9375rem] px-2.5 capitalize whitespace-nowrap sm:text-sm text-xs font-normal border-t border-[#E6E6E6] dark:border-[#444444] text-left text-body-color">
                                                                    <input type='number' name="details[1][qty]" step="0.01" min="1" class="form-control form-control-sm" placeholder="@lang('locale.qty')" required>
                                                                </td>
                                                                <td class="py-[0.9375rem] px-2.5 capitalize whitespace-nowrap sm:text-sm text-xs font-normal border-t border-[#E6E6E6] dark:border-[#444444] text-left">
                                                                    <input type='number' name="details[1][price]" min="500" class="form-control form-control-sm" placeholder="@lang('locale.price')" required>
                                                                </td>
                                                                <td class="py-[0.9375rem] px-2.5 capitalize whitespace-nowrap sm:text-sm text-xs font-normal border-t border-[#E6E6E6] dark:border-[#444444] text-left text-body-color"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>	
                                            ...
                                            <div class="row">                                                
                                                <div class="overflow-x-auto table-scroll">
                                                    <table class="table table-bordered table-striped mb-4 min-w-[30rem] w-full">
                                                        ...
                                                        <tbody id="tbody-affectation"></tbody>
                                                    </table>
                                                </div>	
                                            </div>
                                        </div>
