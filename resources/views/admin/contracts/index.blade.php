    ...
    <div class="container-fluid">
        <div class="flex justify-between items-center mb-3">
            ...
            <div class="flex items-center">
                ...
                <a class="btn btn-success duration-500 hover:bg-hover-primary py-[5px] px-3 text-[13px] rounded text-white bg-primary leading-[18px] inline-block border border-primary ml-2" href="{{ route('contracts.create') }}">+ @lang('locale.add', ['suffix'=>''])</a>
            </div>
        </div>
        <div class="row">
            <div class="w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right border-b border-[#E6E6E6] dark:border-[#444444] text-[13px] py-2.5 px-4 font-normal whitespace-nowrap">
                                            <a class="rounded py-[5px] px-3 text-[13px] text-primary bg-primary leading-[18px] inline-block border border-primary-light bg-primary-light hover:text-white hover:bg-primary" href="{{ route('contracts.pdf', $item->id) }}" style="display: inline-block"><i class="fa fa-file-pdf"></i></a>
