...
<x-app-layout>
    ...
    <div class="page-titles dark:bg-[#242424] flex items-center justify-between relative border-b border-[#E6E6E6] dark:border-[#444444] flex-wrap z-[1] py-[0.6rem] sm:px-[1.95rem] px-[1.55rem] bg-white">
        <ol class="text-[13px] flex items-center flex-wrap bg-transparent">
            ...
            <li class="pl-2 before:content-['/'] before:font-[simple-line-icons] before:font-black before:text-xl before:leading-4 before:pr-2 before:float-left before:text-primary text-primary font-medium"><a>@lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'ies' : 's'])</a></li>
        </ol>
    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="overflow-x-auto active-projects style-1">
                            <div class="tbl-caption flex justify-between items-center flex-wrap p-5 relative z-[2]">
                                <h4 class="max-sm:mb-2.5">@lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'ies' : 's'])</h4>
                                <div>
                                    <a class="rounded py-[5px] px-3 text-[13px] text-success bg-success leading-[18px] inline-block border border-success-light bg-success-light hover:text-white hover:bg-success dz-modal-btn" data-dz-modal="new-category">+ @lang('locale.add')</a>
                                </div>
                            </div>
                            <table id="empoloyees-tblwrapper" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-[13px] py-2.5 px-4 bg-[#F0F4F9] text-[#374557] capitalize font-medium bg-none whitespace-nowrap text-left">@lang('locale.category', ['suffix'=>app()->getLocale() == 'en' ? 'y' : ''])</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-[#E6E6E6] dark:border-[#444444] text-[13px] py-2.5 px-4 font-normal whitespace-nowrap">
                                            <div class="products flex items-center">
                                                <div>
                                                    <h6 class="text-sm whitespace-nowrap">{{ $item->category }}</h6>
                                        ...
                                        <td class="border-b border-[#E6E6E6] dark:border-[#444444] text-[13px] py-2.5 px-4 font-normal whitespace-nowrap text-right">
                                            <a class="rounded py-[5px] px-3 text-[13px] text-primary bg-primary leading-[18px] inline-block border border-primary-light bg-primary-light hover:text-white hover:bg-primary dz-modal-btn" data-dz-modal="edit-category{{ $item->id }}" style="display: inline-block"><i class="fa fa-edit"></i></a>
